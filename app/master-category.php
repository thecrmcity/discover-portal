				...
				<div class="infotrack">
					<form class="" method="POST" action="<?php echo BSURL?>functions/setting.php?case=<?php echo $case;?>&p=<?php echo $siteaim;?>">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="catename" class="form-control" required value="<?php echo $name; ?>">
						</div>
						<div class="form-group">
							
							<input type="radio" name="catefor" checked value="Business" <?php echo $parent =="Business"? "checked":"";?>> <b>Business Information</b>
							
							<br>
							<input type="radio" name="catefor" value="Functional" <?php echo $parent =="Functional"? "checked":"";?>> <b>Functional Requirements</b>
							...
							if(!empty($alldata))
							{
								foreach($alldata as $all)
								{
									...
									<tr>
										...
										<td><?php echo $all['dis_parent'];?></td>
										<td><?php $status = $all['dis_status']; echo $status == "1" ? "Active":"Inactive";?></td>
										<td><a href="<?php echo BSURL?>app/master-category.php?id=<?php echo $all['dis_id'];?>" class="text-success"><i class="fa fa-edit"></i></a></td>
