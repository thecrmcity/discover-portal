										  ...
										  <div class="card">
										    <div class="card-header">
										      <a class="card-link text-dark font-weight-bold" data-toggle="collapse" href="#collapse<?php echo $xl;?>">
										       ...
										       <!-- <span class="float-right"><?php echo $obj->quesetMapped($mdno,$id);?>/<?php echo $obj->quesCount($mdno);?></span> -->
										      </a>
										    </div>
										      ...
										      <div class="card-body">
										        <div class="table-responsive emptable">
													<table class="table table-bordered table-striped">
														...
														<input type="radio" name="ques[]" <?php echo $nature != "Optional" ? "required":"";?> value="Yes"> Yes
														<input type="radio" name="ques[]" <?php echo $nature != "Optional" ? "required":"";?> value="No"> No
															<?php
																break;
																case "Text":
																?>
																<input type="hidden" name="quesid[]" value="<?php echo $qeid;?>">
																<textarea name="ques[]" <?php echo $nature != "Optional" ? "required":"";?> class="form-control"></textarea>
																<?php
																break;
																case "Options":
																?>
																<input type="hidden" name="quesid[]" value="<?php echo $qeid;?>">
																<select name="ques[]" class="form-control" <?php echo $nature != "Optional" ? "required":"";?>>
															...
															<td><textarea name="optional[]" class="form-control"></textarea></td>
