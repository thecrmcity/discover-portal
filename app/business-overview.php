							...
							if(!empty($alldata))
							{
								...
								foreach($alldata as $all)
								{
									...
									<tr>
										...
										<td><?php echo $obj->assignedQues($emi,'Business');?></td>
										<td><?php echo $obj->answeredQues($emi,'Business');?></td>
										<td><?php echo $obj->assignedQues($emi,'Business')-$obj->answeredQues($emi,'Business');?></td>
										<td><a href="business-result.php?s=<?php echo $eta['dis_mainid'];?>&id=<?php echo $emi;?>" class="badge badge-pill badge-primary">View <i class="fa fa-angle-double-right"></i></a></td>
