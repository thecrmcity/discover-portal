	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4">
				...
				if(isset($_GET['case']))
				{
					...
					switch($case)
					{
						...
						if($one != "")
						{
							...
							$company = $one['dis_company'];

						}
						?>
						<form class="infotrack mt-4" method="POST" action="<?php echo BSURL?>functions/setting.php?case=<?php echo $case;?>" enctype="multipart/form-data">
					<h5 class="text-center border-bottom pb-2" style="color: #597b81;font-family: arial;">User Creation</h5>
					<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="file" name="comlogo" class="form-control">
						</div>
						<div class="form-group">
						...
						case "password":
						?>
						<form class="infotrack mt-4" method="POST" action="<?php echo BSURL?>functions/setting.php?case=userpass&id=<?php echo $_GET['id']?>" enctype="multipart/form-data">
							<div class="form-group">
				...
				{
					?>
					<form class="infotrack mt-4" method="POST" action="<?php echo BSURL?>functions/setting.php?case=adduser" enctype="multipart/form-data">
					<h5 class="text-center border-bottom pb-2" style="color: #597b81;font-family: arial;">User Creation</h5>
					<div class="form-group">
						...
						<div class="form-group">
							<label>Company Logo</label>
							<input type="file" name="comlogo" class="form-control" required >
						</div>
						<div class="form-group">
							<input type="submit" value="Save" class="btn btn-primary">
						</div>
							...
							if(!empty($alldata))
							{
								...
								foreach($alldata as $all)
								{
									...
									<tr>
										...
										{
											?>
											<td><img src="<?php echo BSURL?>uploads/<?php echo $logo;?>" width="40px"></td>
											<?php
										}
										else
										{
										...
										<td><a href="<?php echo APP?>add-user.php?case=password&id=<?php echo $all['dis_id'];?>" class="text-success"><i class="fa fa-key"></i></a></td>
										<td><a href="<?php echo APP?>add-user.php?case=edit&id=<?php echo $all['dis_id'];?>" class="text-success"><i class="fa fa-edit"></i></a></td>
